package com.ag.github.producer.model;
...
public class DomainModel {
    ...
    public DomainModel(HttpServletRequest httpServletRequest, String className) throws IOException, ClassNotFoundException {
        init(httpServletRequest, className);
    }

    private void init(HttpServletRequest httpServletRequest, String className) throws IOException, ClassNotFoundException {
    ...
    public DomainModel setException(Exception exception) {
