...
@Service
public class ProducerService extends HandlerService {

    @Override
    public void handle(DomainModel domainModel) throws IOException {
        InputStream inputStream = domainModel.getHttpServletRequest().getInputStream();
